        ...
        <div class="users container">
            ...
            <div class="home-menu-list">
                <dl class="home-menu-list-item">
                    <dt class="home-category-name"><a href="/categories/1" class="home-menu-btn1">着物ショップ</a></dt>
                    <dd class="home-category-text">安心してお買い物しましょ</dd>
                </dl>
                <dl class="home-menu-list-item">
                    <dt class="home-category-name"><a href="/categories/2" class="home-menu-btn2">着物コーデ</a></dt>
                    <dd class="home-category-text">このコーディネートが好き</dd>
                </dl>
                <dl class="home-menu-list-item">
                    <dt class="home-category-name"><a href="/categories/3" class="home-menu-btn3">着付けテクニック</a></dt>
                    <dd class="home-category-text">簡単に着る方法ないですか？</dd>
                </dl>
                <dl class="home-menu-list-item">
                    <dt class="home-category-name"><a href="/categories/4" class="home-menu-btn4">着物姿の芸能人</a></dt>
                    <dd class="home-category-text">おしゃれな芸能人探し</dd>
                </dl>
                <dl class="home-menu-list-item">
                    <dt class="home-category-name"><a href="/categories/5" class="home-menu-btn5">着物警察</a></dt>
                    <dd class="home-category-text">ある日突然警察に襲われた</dd>
                </dl>
                <dl class="home-menu-list-item">
                    <dt class="home-category-name"><a href="/categories/6" class="home-menu-btn6">お手入れ・収納</a></dt>
